                ...
                <table class="table table-bordered table-hover table-striped table-checkable table-highlight-head mb-4">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="checkbox-column">
                                <span style="font-size: 18px;" class="fa fa-thumbs-{{ $item->verified ? 'up' : 'down' }} text-{{ $item->verified ? 'primary' : 'danger' }}"></span>
                            </td>

                            <td class="text-center">
                                <a data-toggle="tooltip" href="{{ route('admin.users.edit', $item->id) }}"
