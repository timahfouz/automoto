            ...
            <div class="row">
                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                    ...
                    {{-- <div class="float-lg-right">
                        <a class="btn btn-primary" href="{{ route('admin.categories.create') }}"> Create New Case </a>
                    </div> --}}
                </div>
            </div>
        </div>
                ...
                <table class="table table-bordered table-hover table-striped table-checkable table-highlight-head mb-4">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="checkbox-column">
                                <b style="font-size: 18px;">{{ $item->phone }}</b>
                            </td>
                            <td class="checkbox-column">
                                <b style="font-size: 18px;">{{ $item->email }}</b>
                            </td>

                            <td class="text-center">
                                <a data-toggle="tooltip" href="{{ route('admin.cases.show', $item->id) }}"
