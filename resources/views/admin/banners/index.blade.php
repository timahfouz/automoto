            ...
            <div class="row" style="padding: 24px;">
                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="float-lg-right">
                        <a class="btn btn-primary" href="{{ route('admin.banners.create') }}"> Add New Banner </a>
                    </div>
                </div>
            </div>
        </div>
        <div class="widget-content widget-content-area">
            <div class="table-responsive">
                <table class="table table-bordered table-hover table-striped table-checkable table-highlight-head mb-4">
                    ...
                    <thead>
                    <tr>
                        <th class="">Banner ID</th>
                        <th class="">Banner Image</th>
                        <th class="">Banner Description</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a data-toggle="tooltip" href="{{ route('admin.banners.edit', $item->id) }}"
